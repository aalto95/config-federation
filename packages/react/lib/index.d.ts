...
export type DeepMergeCustomRules<T> =
	T extends Array<infer U>
		? Array<DeepMergeCustomRules<U>>
		: T extends object
			? { [K in keyof T]?: DeepMergeCustomRules<T[K]> } & Record<
					string,
					unknown
				>
			: T;
...
export function deepMerge<
	TConfig,
	TCustoms extends DeepMergeCustomRules<TConfig>,
>(config: TConfig, customs: TCustoms): TConfig & TCustoms;
